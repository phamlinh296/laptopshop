                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://www.facebook.com/" target="_blank">
                                ...
                                <p class="text-secondary mb-0">mylaptop</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Website: <a href="https://www.facebook.com/" target="_blank"> mylaptop</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://www.facebook.com/" target="_blank"><i
